...
# 반복문으로 구현하기
        ...
        numLayout.addWidget(self.digitButton[0], 3, 1)
        numLayout.addWidget(self.digitButton[1], 0, 0)
        numLayout.addWidget(self.digitButton[2], 0, 1)
        numLayout.addWidget(self.digitButton[3], 0, 2)
        ...
        numLayout.addWidget(self.digitButton[7], 2, 0)
        numLayout.addWidget(self.digitButton[8], 2, 1)
        numLayout.addWidget(self.digitButton[9], 2, 2)

        numLayout.addWidget(self.decButton, 3, 0)
